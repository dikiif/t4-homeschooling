...
<html>
<head>
  <link rel="icon" type="image/ico" href="img/logo-t4-full.png"/>
  <meta charset="UTF-8">
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
    <title>Daftar &mdash; T4 Homeschooling</title>
    <!-- General CSS Files -->
        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div class="login-brand">
              <img src="img/logo-t4-full.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
